...
urlpatterns = [
 ...
 #**********************Training project ******************
    ...
    path('trainer_reportissue/', training_views.trainer_reportissue, name='trainer_reportissue'),
    path('trainer_reportissue_form/', training_views.trainer_reportissue_form, name='trainer_reportissue_form'),
    path('trainer_reportedissue_table/', training_views.trainer_reportedissue_table, name='trainer_reportedissue_table'),
    path('trainer_myreportissue_table/', training_views.trainer_myreportissue_table, name='trainer_myreportissue_table'),
    ...
    path('trainer_currenttrainees/', training_views.trainer_currenttrainees, name='trainer_currenttrainees'),
    path('trainer_currenttraineesdetails/', training_views.trainer_currenttraineesdetails, name='trainer_currenttraineesdetails'),
    path('trainer_currentattentable/', training_views.trainer_currentattentable, name='trainer_currentattentable'),
    path('trainer_currentperform/', training_views.trainer_currentperform, name='trainer_currentperform'),
    path('trainer_currentattenadd/', training_views.trainer_currentattenadd, name='trainer_currentattenadd'),
    path('trainer_previousteam/', training_views.trainer_previousteam, name='trainer_previousteam'),
    path('trainer_previoustrainees/', training_views.trainer_previoustrainees, name='trainer_previoustrainees'),
    path('trainer_previoustraineesdetails/', training_views.trainer_previoustraineesdetails, name='trainer_previoustraineesdetails'),
    path('trainer_previousattentable/', training_views.trainer_previousattentable, name='trainer_previousattentable'),
    path('trainer_previousperfomtable/', training_views.trainer_previousperfomtable, name='trainer_previousperfomtable'),
    path('trainer_current_attendance/', training_views.trainer_current_attendance, name='trainer_current_attendance'),
    path('trainer_current_attendance_view/', training_views.trainer_current_attendance_view, name='trainer_current_attendance_view'),
    ...
    path('trainer_previous_trainees/', training_views.trainer_previous_trainees, name='trainer_previous_trainees'),
    path('trainer_current_trainees/', training_views.trainer_current_trainees, name='trainer_current_trainees'),
   ...
   path('Admin_courses/', training_views.Admin_courses, name='Admin_courses'),
   path('Admin_emp_course_list/', training_views.Admin_emp_course_list,name='Admin_emp_course_list'),
   path('Admin_emp_course_details/', training_views.Admin_emp_course_details,name='Admin_emp_course_details'),
   path('Admin_emp_profile/', training_views.Admin_emp_profile, name='Admin_emp_profile'),
   ...
   path('Admin_coursedetails/', training_views.Admin_coursedetails, name='Admin_coursedetails'),
    ...
    path('accounts_emp_dep/', training_views.accounts_emp_dep, name='accounts_emp_'),
    path('accounts_emp_list/', training_views.accounts_emp_list, name='accounts_emp_list'),
    ...
    path('accounts_expenses_viewEdit/', training_views.accounts_expenses_viewEdit, name='accounts_expenses_viewEdit'),
    path('accounts_expenses_viewEdit_Update/', training_views.accounts_expenses_viewEdit_Update, name='accounts_expenses_viewEdit_Update'),
    ...
    path('accounts_payment_list/', training_views.accounts_payment_list, name='accounts_payment_list'),
    path('accounts_payment_details/', training_views.accounts_payment_details, name='accounts_payment_details'),
    path('accounts_payment_detail_list/', training_views.accounts_payment_detail_list, name='accounts_payment_detail_list'),
